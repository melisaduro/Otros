...
if @client=1
begin
	set @table='lcc_position_Entity_List_Vodafone'
end

if @client=3
begin
	if db_name like '%Indoor%' or db_name like '%Road%' or db_name like '%AVE%'
	begin
		set @table='lcc_position_Entity_List_Orange'
	end
	else
	begin
		set @table='lcc_position_Entity_List_Municipio'
	end
end
...
set @cmd=('
select entity_name, fileidB 
into _entities_fileid 
from '+@table+'
